...
PRECEDENCES: dict[TokenType, PrecedenceType] = {
    ...
    TokenType.PERCENT: PrecedenceType.P_PRODUCT,
...
class Parser:
    ...
    def __current_precedence(self) -> PrecedenceType:
        prec: PrecedenceType = PRECEDENCES.get(self.current_token.type, PrecedenceType.P_LOWEST)
        return prec
    
    def __peek_precedence(self) -> PrecedenceType:
        prec: PrecedenceType = PRECEDENCES.get(self.peek_token.type, PrecedenceType.P_LOWEST)
        return prec
